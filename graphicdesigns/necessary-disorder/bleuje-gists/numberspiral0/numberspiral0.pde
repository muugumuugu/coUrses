...
class Digit{
  ...
  int seed2 = floor(random(10,1000));
  
  void show(float p){
    int mult = floor(2*seed2+300*(1+p+0.7*(float)noise.eval(1.0*p,seed)));
    
    int d = (seed2+mult*2017)%10;
    
    //int ts = floor(5+5*constrain(20*p,0,1));
