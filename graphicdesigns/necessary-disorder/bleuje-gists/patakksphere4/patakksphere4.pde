...
PVector field(float x,float y,float z){
  ...
  float amount = 80;
  float turn = -0.7;
  //return new PVector(amount*(float)noise.eval(seed+scl*x,scl*y,scl*z),amount*(float)noise.eval(seed+100+scl*x,scl*y,scl*z)+40,20+amount*(float)noise.eval(seed+200+scl*x,scl*y,scl*z));
  //return new PVector(amount*(float)noise.eval(seed+scl*x,scl*y,scl*z)+50*sin(8*PI*y*y/R/R),amount*(float)noise.eval(seed+100+scl*x,scl*y,scl*z)+20,20+amount*(float)noise.eval(seed+200+scl*x,scl*y,scl*z));
  return new PVector(amount*(float)noise.eval(seed+scl*x,scl*y,scl*z)-turn*z,amount*(float)noise.eval(seed+100+scl*x,scl*y,scl*z)+20,10+amount*(float)noise.eval(seed+200+scl*x,scl*y,scl*z)+turn*x);
}
