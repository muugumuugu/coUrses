...
#
# USAGE:
# & The PGM format was chosen mostly because it was easy to write ... if you
#   are looking for a viewer or a converter, I would recommend ImageMagick, or
#   GIMP. There are numerous other programs that can read/write this format.
#
