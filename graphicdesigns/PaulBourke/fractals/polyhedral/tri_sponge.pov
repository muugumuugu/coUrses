...
// INSIDE WEIRD MENGER SPONGE -- TRIANGLE VERSION (Fastest)
...
light_source
{ <4.5,4.5,4.5> color red 0.9 green 0.5 blue 0.3 }
light_source
...
#declare Render_Level_7 = yes;  //8000
#declare Render_Level_8 = no;   //160000 (393600 triangles)
