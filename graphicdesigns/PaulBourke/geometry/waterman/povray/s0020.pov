...
#declare texture13 = texture {
   pigment { color rgb <0,1,0.7> }
   finish { specular 0.2 }
}
#declare texture14 = texture {
   pigment { color rgb <0,1,0.6> }
   finish { specular 0.2 }
}
...
#declare texture21 = texture {
   pigment { color rgb <0.1,1,0> }
   finish { specular 0.2 }
}
#declare texture22 = texture {
   pigment { color rgb <0.2,1,0> }
   finish { specular 0.2 }
}
